...
export function ChatPage({ activeChat }: { activeChat: number | null }) {
  return (
    <ScrollArea className="min-h-screen w-full flex flex-col items-center justify-between gap-4 p-4 glassmorphism">
      <div className="w-full minh-screen h-full p-4 mx-4 bg-background rounded-lg shadow-lg overflow-y-auto">
