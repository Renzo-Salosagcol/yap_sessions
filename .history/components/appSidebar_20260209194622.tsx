...
export function AppSidebar({ activeChat, setActiveChat }: { activeChat: number | null, setActiveChat: (chatId: number) => void }) {
  ...
  return (
    <Sidebar className="bg-background text-foreground h-full min-h-screen z-101">
      <SidebarHeader className="bg-background flex flex-row items-center justify-between">
        ...
        <div className="gap-1 text-foreground">
          <Button onClick={handleSignOut} variant="ghost" size="sm" className="p-2"><Settings /></Button>
