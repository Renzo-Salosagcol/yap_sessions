...
const testChats = [
  { id: 1, name: "Chat 1", recents: {message: "Hello there!", time: "10:00 AM"} },
  { id: 2, name: "Chat 2", recents: {message: "How are you?", time: "11:00 AM"} },
  { id: 3, name: "Chat 3", recents: {message: "Goodbye!", time: "12:00 PM"} },
]
        ...
        {testChats.map((chat) => (
          <SidebarGroup key={chat.id} className="hover:bg-accent/50 gradient-border">
            <div className="p-4">
              ...
              <div className="text-sm text-muted-foreground">{chat.recentMessage}</div>
            </div>
            <Button className="w-full rounded-xl flex">
