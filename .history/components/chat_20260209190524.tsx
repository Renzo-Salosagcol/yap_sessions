...
export function ChatPage({ activeChat }: { activeChat: number | null }) {
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-between gap-4 bg-red-900 pt-4">
      <h1>Active Chat: Active Chat: Active Chat: Active Chat: Active Chat: Active Chat: Active Chat: Active Chat: Active Chat: Active Chat: Active Chat: Active Chat: Active Chat: Active Chat: Active Chat: Active Chat: Active Chat: Active Chat: {activeChat}</h1>
