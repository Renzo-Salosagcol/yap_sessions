  ...
  return (
    <Sidebar className="bg-background text-foreground h-full min-h-screen z-11">
      <SidebarHeader className="bg-background flex flex-row items-center justify-between">
        ...
        <div className="gap-1 text-foreground">
          <HoverCard>
            <HoverCardTrigger>
              <Button onClick={handleSignOut} variant="ghost" size="sm" className="p-2"><LogOut /></Button>
            </HoverCardTrigger>
            <HoverCardContent className="bg-foreground text-background w-full p-3 text-xs flex flex-col items-center justify-center rounded-lg">
              Sign Out
            </HoverCardContent>
          </HoverCard>
