...
export function AppSidebar() {
  ...
  return (
    <Sidebar className="bg-background text-foreground h-full min-h-screen">
      ...
      <SidebarContent className="bg-background w-full h-full">
        {testChats.map((chat) => (
          <SidebarGroup key={chat.id} className="gradient-border p-1 mx-auto">
            <Button className="w-full rounded-xl flex flex-col items-center justify-center bg-background hover:bg-background text-foreground">
