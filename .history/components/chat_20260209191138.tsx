  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-between gap-4 pt-4 glassmorphism">
      <div className="w-full minh-screen h-full p-4 mx-2 bg-background rounded-lg shadow-lg overflow-y-auto">
        <h1 className="glassmorphism w-full fixed top-0 left-0 p-4flex items-center justify-center">Active Chat: {activeChat}</h1>
        {
      ...
      <div className="bottom-0 left-0 w-full p-2 bg-background flex flex-row items-center justify-center gap-4 glassmorphism">
