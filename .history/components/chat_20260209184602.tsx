...
export function ChatPage({ activeChat }: { activeChat: number | null }) {
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center gap-4 bg-red-900">
      <h1>Active Chat: {activeChat}</h1>
      <div className="absolute bottom-0 left-0 w-full p-2 bg-background flex flex-row items-center justify-center gap-4">
