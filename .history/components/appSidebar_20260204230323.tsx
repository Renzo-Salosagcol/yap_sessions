  ...
  return (
    <Sidebar className="bg-background text-foreground h-full min-h-screen">
      ...
      <SidebarContent className="bg-background w-full h-full">
        {testChats.map((chat) => (
          <SidebarGroup key={chat.id} className="">
            <Button className="w-full rounded-xl flex flex-col items-center justify-center px-2 py-8">
              ...
              <div className="items-start w-full text-sm text-muted-foreground mt-2">
